<template>
  <div>
    <div class="mb-5 flex justify-between">
      <h2 class="text-preset-2 font-bold">Recurring Bills</h2>
      <a class="flex items-center gap-x-3" href="/recurring_bills">
    ...
    <div class="flex flex-col gap-3">
      <UiBlockBeige
        class="flex w-full items-center justify-between border-l-4 border-green"
      >
        <div class="text-preset-4 text-gray-500">Paid Bills</div>
        <div class="text-preset-4 font-bold text-gray-900">$190.00</div>
      </UiBlockBeige>
      <UiBlockBeige
        class="flex w-full items-center justify-between border-l-4 border-yellow"
      >
        <div class="text-preset-4 text-gray-500">Total Upcoming</div>
        <div class="text-preset-4 font-bold text-gray-900">$194.98</div>
      </UiBlockBeige>
      <UiBlockBeige
        class="flex w-full items-center justify-between border-l-4 border-cyan"
      >
        <div class="text-preset-4 text-gray-500">Due Soon</div>
        <div class="text-preset-4 font-bold text-gray-900">$60.00</div>
      </UiBlockBeige>
    </div>
  </div>
</template>
