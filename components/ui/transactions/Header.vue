<template>
  <div class="mb-6 flex items-center justify-between">
    <div class="relative">
      <input
        type="text"
        class="block h-11 w-80 flex-1 rounded-md border border-gray-500 py-3 pl-5 pr-10 text-gray-900 focus:outline-none"
    ...
    <div class="flex items-center gap-2 justify-self-end">
      <div class="text-preset-4 text-gray-500">Sort by</div>
      <input
        type="text"
        class="block h-11 w-28 flex-1 rounded-md border border-gray-500 py-3 pl-5 pr-10 text-gray-900 focus:outline-none"
      />
    </div>
    <div class="flex items-center gap-2 justify-self-end">
      <div class="text-preset-4 text-gray-500">Category</div>
      <input
        type="text"
        class="block h-11 w-44 flex-1 rounded-md border border-gray-500 py-3 pl-5 pr-10 text-gray-900 focus:outline-none"
      />
    </div>
  </div>
</template>
